config = {
    ...
    blip = {
        ...
        deleteText = 'Ruta hacia postal finalizada/cancelada.',

        -- The text to display in chat when drawing a new route
        drawRouteText = 'Trazando ruta GPS hacia el postal %s...',

        -- The text to display when a postal is not found.
        notExistText = "El codigo postal no existe en el mapa."
    },
